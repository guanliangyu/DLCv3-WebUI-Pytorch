...
from src.core.processing.three_chamber_video_processing import process_three_chamber_files
...
def show():
    ...
    # 设置模型
    models = {
        "ICR-DJ-Three-Chamber-V2": os.path.join(get_models_path(), "ABmodels/DJ-three-chamber-500px-narrow-2024-05-13/config.yaml"),
