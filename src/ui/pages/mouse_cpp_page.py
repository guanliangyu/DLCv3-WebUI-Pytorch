...
# File processing
from src.core.processing.mouse_cpp_video_processing import process_mouse_cpp_video, process_cpp_files
...
def mouse_cpp_page():
    ...
    models = {
        "小鼠位置偏好/Mouse CPP": os.path.join(get_models_path(), "ABmodels/C57-CPP-2024-08-19/config.yaml")
    }
